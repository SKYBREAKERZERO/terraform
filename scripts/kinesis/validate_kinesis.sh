...
VALIDATE_SCRIPT="${PROJECT_ROOT}/python/src/kinesis/validate_kinesis.py"
...
if [[ ! -f "${VALIDATE_SCRIPT}" ]]; then
  echo "[ERROR] Kinesis validator was not found:"
  echo "  ${VALIDATE_SCRIPT}"
  exit 1
fi

echo "[PASS] validate_kinesis.py exists."
...
echo "======================================================================"
echo "RUNNING KINESIS VALIDATION"
echo "======================================================================"
echo
...
echo
echo "======================================================================"
echo "KINESIS VALIDATION RESULT"
echo "======================================================================"

if [[ ${VALIDATE_EXIT_CODE} -eq 0 ]]; then

  echo
  echo "[PASS] Kinesis validation completed successfully."
  echo

else

  echo
  echo "[FAIL] Kinesis validation failed."
